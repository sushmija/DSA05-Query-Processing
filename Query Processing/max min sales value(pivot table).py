...
pivot_table = pd.pivot_table(sales_data, values='Sale_amt', index='Item', aggfunc=['min', 'max'])

print("Pivot Table:")
print(pivot_table)

max_sale_value = sales_data['Sale_amt'].max()
min_sale_value = sales_data['Sale_amt'].min()
